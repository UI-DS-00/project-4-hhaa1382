...
public class Page extends JFrame {
    public Page(){
        ...
        layout.putConstraint(SpringLayout.NORTH,btnSearch,50,SpringLayout.NORTH,this.getContentPane());
        layout.putConstraint(SpringLayout.WEST,btnSearch,40,SpringLayout.EAST,text);

        JTextArea result=new JTextArea();
        result.setEditable(false);
        result.setPreferredSize(new Dimension(500,200));
        result.setFont(new Font(Font.SANS_SERIF,Font.BOLD,24));
        layout.putConstraint(SpringLayout.NORTH,result,100,SpringLayout.SOUTH,btnSearch);
